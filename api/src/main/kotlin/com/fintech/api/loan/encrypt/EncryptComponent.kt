package com.fintech.api.loan.encrypt
...
class EncryptComponent {
    companion object {
        private const val KEY = "12345678901234561234567890123456"
        }
    ...
    fun encryptString(encryptString: String): String {
        val encryptedString = cipherPkcs5(Cipher.ENCRYPT_MODE, KEY)
    ...
    fun decryptString(decryptString: String): String {
        ...
        return String(cipherPkcs5(Cipher.DECRYPT_MODE, KEY).doFinal(byteString))
    }
